            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Editar Rol en Permiso</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" readonly name="name" value="{{ $role->name }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-3">
                                    ...
                                    @endphp
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="formCheck1" {{ App\Models\User::roleHasPermissions($role, $permissions) ? 'checked' : '' }}>
                                ...
                                <div class="col-9">
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" name="permission[]"  {{ $role->hasPermissionTo($permission->name) ? 'checked' : '' }} value="{{ $permission->name }}" type="checkbox" id="formCheck1{{ $permission->id }}">
